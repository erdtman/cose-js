...
const AlgToTags = {
  ...
  // 'AES-CCM-16-64-256': 11, not supported
  // 'AES-CCM-16-256/64': 11, not supported
  'AES-CCM-64-64-128': 12,
  'AES-CCM-64-128/64': 12,
  // 'AES-CCM-64-64-256': 13, not supported
  // 'AES-CCM-64-256/64': 13, not supported
  'AES-CCM-16-128-128': 30,
  'AES-CCM-16-128/128': 30,
  // 'AES-CCM-16-128-256': 31, not supported
  // 'AES-CCM-16-256/128': 31, not supported
  'AES-CCM-64-128-128': 32,
  'AES-CCM-64-128/128': 32
  // 'AES-CCM-64-128-256': 33, not supported
  // 'AES-CCM-64-256/128': 33 not supported
};
