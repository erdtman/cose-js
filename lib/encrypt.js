...
const keyLength = {
  ...
  // 11: 32, // AES-CCM-16-64-256 not supported
  12: 16,  // AES-CCM-64-64-128
  // 13: 32,  // AES-CCM-64-64-256 not supported
  30: 16, // AES-CCM-16-128-128
  // 31: 32, // AES-CCM-16-128-256 not supported
  32: 16,  // AES-CCM-64-128-128
  // 33: 32   // AES-CCM-64-128-256 not supported
  'P-521': 66,
  'P-256': 32
};
  ...
  return new Promise((resolve, reject) => {
    ...
    if (Array.isArray(recipients)) {
      ...
      if (isNodeAlg[alg]) {
        ...
        ciphertext = ccmEncrypt(payload, key, alg, iv, aad);
      } else {
